    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up pb-12 p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-gray-900">Configure new Plan</h2>
            <p className="text-sm text-gray-500">Design a perfect subscription package for schools</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="space-y-8">
          ...
          >
            ...
            {loading ? 'Publishing...' : 'Create & Launch Plan'}
          </button>
        </div>
