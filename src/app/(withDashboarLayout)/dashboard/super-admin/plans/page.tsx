...
import { 
  ...
  Trash2, Users, UserRound, HardDrive, LayoutGrid, Edit, Hash 
} from 'lucide-react'

// Mock Data with specific IDs
const plans = [
  { 
    id: "plan_9921", // নির্দিষ্ট আইডি
    name: "Basic", 
    price: "৳2,000", 
    duration: "1 Month", 
    icon: Zap, 
  ...
  { 
    ...
    teachers: "100", 
    storage: "50GB",
    modules: ["Attendance", "Exams", "Finance", "SMS"] 
  },
]

export default function PlansSetup() {
  
  // ডিলিট করার ফাংশন যেখানে ID পাস হবে
  const handleDeletePlan = (id: string) => {
    const confirmDelete = confirm(`Are you sure you want to delete plan ID: ${id}?`);
    if (confirmDelete) {
      console.log(`Deleting plan with ID: ${id}`);
      // এখানে তোমার API কল হবে: axios.delete(`/api/plans/${id}`)
      alert(`Plan ${id} deleted successfully!`);
    }
  };
