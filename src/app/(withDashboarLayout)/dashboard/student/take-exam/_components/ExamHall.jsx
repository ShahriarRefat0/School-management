...
const ExamHall = ({ examData, user, result, setResult, clearSession }) => {
  ...
  return (
    <div className="bg-bg-page dark:bg-slate-950 min-h-screen font-display text-text-primary pb-20">
      <main className="flex justify-center py-10 px-4">
        <div className="max-w-[850px] flex-1 flex flex-col gap-6">
          {/* Header with Timer & Title */}
          <div className="flex flex-wrap justify-between items-center bg-bg-card p-6 rounded-[2rem] border border-border-light shadow-sm gap-4">
            ...
            <div className="px-5 py-2 rounded-full bg-bg-page text-text-secondary text-[10px] font-black uppercase tracking-widest border border-border-light">
              {examData.roomCode}
            </div>
          </div>

          {/* Progress Section */}
          <div className="flex flex-col gap-4 p-6 bg-bg-card rounded-[2rem] shadow-sm border border-border-light">
          ...
          {/* Question Card */}
          <div className="p-8 md:p-12 bg-bg-card rounded-[3rem] shadow-sm border border-border-light relative overflow-hidden min-h-[400px]">
            ...
            <h2 className="text-text-primary text-2xl font-black mb-10 leading-tight">
              ...
              {currentQ &&
                Object.entries(currentQ.options).map(([key, value]) => (
                  ...
                  >
                    ...
                    <span
                      className={`font-bold text-lg ${answers[currentQ.id] === key ? 'text-text-primary' : 'text-text-secondary'}`}
                    >
                      {value}
                    </span>
                  </button>
          ...
          <div className="flex justify-between items-center mt-4">
            <button
              ...
              className="flex items-center gap-2 px-8 py-4 rounded-2xl border border-border-light bg-bg-card text-text-secondary font-black uppercase text-[10px] tracking-widest hover:bg-bg-page disabled:opacity-30 transition-all active:scale-95"
            >
      ...
      <aside className="fixed right-8 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-6 w-64 bg-bg-card p-8 rounded-[2.5rem] border border-border-light shadow-xl">
