...
export function AccountantHeader({ title, onMenuClick }: AccountantHeaderProps) {
    ...
    return (
        <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-border-light bg-bg-card/80 px-6 backdrop-blur-md transition-colors">
            ...
            <div className="flex-1">
                <h1 className="text-xl font-black text-text-primary tracking-tight hidden sm:block md:block">Accountant Dashboard</h1>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative">
                    ...
                    {isProfileOpen && (
                        <div className="absolute right-0 mt-2 w-56 rounded-md border bg-re border-slate-200 bg-white py-1 shadow-lg dark:border-slate-800 dark:bg-slate-950">
